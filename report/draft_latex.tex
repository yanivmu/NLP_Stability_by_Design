...
The most crucial takeaway emerges from the QASC task: applying the Structure prompt severely crashes the accuracy (dropping to 22.1\%), yet it appears highly `stable' due to a reduced variation ratio. This exemplifies the `misleading stability' that motivated our research, demonstrating that a low variation ratio is not a measure of robust competence if the model is merely producing consistent errors.
