...
Our framework is inference-only. We do not fine-tune any model parameters. Instead, we evaluate how the same pretrained model behaves when the same task is presented through different prompt styles and through semantic-preserving input perturbations. The overall evaluation flow is summarized in Algorithm~\ref{alg:pipeline}. The process consists of four main stages: (1) Out-of-the-Box (OOTB) screening to ensure baseline task competence, (2) Perturbation generation to create semantic variants, (3) Model inference across all prompt versions, and (4) Metric calculation to quantify sensitivity and accuracy.
...
This section provides a global summary for each model, aggregating results across all datasets and perturbation types. These plots show the average absolute change in Accuracy and Sensitivity relative to the Control baseline.
...
\midrule
% Flan-T5-Base
{\small OOTB Accuracy too low} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/both/impact_plot_flan-t5-base_csqa.pdf} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/both/impact_plot_flan-t5-base_qasc.pdf} \\
 \multicolumn{3}{c}{\small Flan-T5-Base} \\[0.5em]

% Flan-T5-Large
\includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/both/impact_plot_flan-t5-large_cola.pdf} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/both/impact_plot_flan-t5-large_csqa.pdf} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/both/impact_plot_flan-t5-large_qasc.pdf} \\
 \multicolumn{3}{c}{\small Flan-T5-Large} \\[0.5em]

% Llama-3.2-1B
\includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/both/impact_plot_llama-3.2-1b_cola.pdf} & {\small OOTB Accuracy too low} & {\small OOTB Accuracy too low} \\
 \multicolumn{3}{c}{\small Llama-3.2-1B} \\[0.5em]

% Llama-3.2-1B-Instruct
\includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/both/impact_plot_llama-3.2-1b-instruct_cola.pdf} & {\small OOTB Accuracy too low} & {\small OOTB Accuracy too low} \\
 \multicolumn{3}{c}{\small Llama-3.2-1B-Instruct} \\[0.5em]

% Phi-3-Mini
\includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/both/impact_plot_phi-3-mini_cola.pdf} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/both/impact_plot_phi-3-mini_csqa.pdf} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/both/impact_plot_phi-3-mini_qasc.pdf} \\
 \multicolumn{3}{c}{\small Phi-3-Mini} \\[0.5em]

% Pythia-410M
\includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/both/impact_plot_pythia-410m_cola.pdf} & {\small OOTB Accuracy too low} & {\small OOTB Accuracy too low} \\
...
\midrule
% Flan-T5-Base
{\small OOTB Accuracy too low} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/synonyms/impact_plot_flan-t5-base_csqa.pdf} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/synonyms/impact_plot_flan-t5-base_qasc.pdf} \\
 \multicolumn{3}{c}{\small Flan-T5-Base} \\[0.5em]

% Flan-T5-Large
\includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/synonyms/impact_plot_flan-t5-large_cola.pdf} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/synonyms/impact_plot_flan-t5-large_csqa.pdf} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/synonyms/impact_plot_flan-t5-large_qasc.pdf} \\
 \multicolumn{3}{c}{\small Flan-T5-Large} \\[0.5em]

% Llama-3.2-1B
\includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/synonyms/impact_plot_llama-3.2-1b_cola.pdf} & {\small OOTB Accuracy too low} & {\small OOTB Accuracy too low} \\
 \multicolumn{3}{c}{\small Llama-3.2-1B} \\[0.5em]

% Llama-3.2-1B-Instruct
\includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/synonyms/impact_plot_llama-3.2-1b-instruct_cola.pdf} & {\small OOTB Accuracy too low} & {\small OOTB Accuracy too low} \\
 \multicolumn{3}{c}{\small Llama-3.2-1B-Instruct} \\[0.5em]

% Phi-3-Mini
\includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/synonyms/impact_plot_phi-3-mini_cola.pdf} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/synonyms/impact_plot_phi-3-mini_csqa.pdf} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/synonyms/impact_plot_phi-3-mini_qasc.pdf} \\
 \multicolumn{3}{c}{\small Phi-3-Mini} \\[0.5em]

% Pythia-410M
\includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/synonyms/impact_plot_pythia-410m_cola.pdf} & {\small OOTB Accuracy too low} & {\small OOTB Accuracy too low} \\
 \multicolumn{3}{c}{\small Pythia-410M} \\
\end{tabular}
...
\midrule
% Flan-T5-Base
{\small OOTB Accuracy too low} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/paraphrasing/impact_plot_flan-t5-base_csqa.pdf} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/paraphrasing/impact_plot_flan-t5-base_qasc.pdf} \\
 \multicolumn{3}{c}{\small Flan-T5-Base} \\[0.5em]

% Flan-T5-Large
\includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/paraphrasing/impact_plot_flan-t5-large_cola.pdf} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/paraphrasing/impact_plot_flan-t5-large_csqa.pdf} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/paraphrasing/impact_plot_flan-t5-large_qasc.pdf} \\
 \multicolumn{3}{c}{\small Flan-T5-Large} \\[0.5em]

% Llama-3.2-1B
\includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/paraphrasing/impact_plot_llama-3.2-1b_cola.pdf} & {\small OOTB Accuracy too low} & {\small OOTB Accuracy too low} \\
 \multicolumn{3}{c}{\small Llama-3.2-1B} \\[0.5em]

% Llama-3.2-1B-Instruct
\includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/paraphrasing/impact_plot_llama-3.2-1b-instruct_cola.pdf} & {\small OOTB Accuracy too low} & {\small OOTB Accuracy too low} \\
 \multicolumn{3}{c}{\small Llama-3.2-1B-Instruct} \\[0.5em]

% Phi-3-Mini
{\small Plot not available} & \includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/paraphrasing/impact_plot_phi-3-mini_csqa.pdf} & {\small Plot not available} \\
 \multicolumn{3}{c}{\small Phi-3-Mini} \\[0.5em]

% Pythia-410M
\includegraphics[width=0.25\textwidth]{../outputs/figures/phase_6/paraphrasing/impact_plot_pythia-410m_cola.pdf} & {\small OOTB Accuracy too low} & {\small OOTB Accuracy too low} \\
 \multicolumn{3}{c}{\small Pythia-410M} \\
\end{tabular}
